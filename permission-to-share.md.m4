...
# Databrary
## Permission to Share Recordings PICK(,Minors 12-17 Years of Age,of Child)

### Overview

This form requests permission to include video/audio recordings or still images of CHILD(your child,you) in a secure data library on the Internet (Databrary.org). The library allows authorized researchers to share data. Data sharing will help researchers to learn more and will lead to faster progress in our understanding of human development.

Giving permission to share is entirely separate from giving consent to participate in a research study. You do not have to give permission to share your CHILDS video/audio recordings or still images in the library. Your choice will not affect your receipt of payment if offered for CHILD(your child's) participation in this or future studies.

### What will be shared?

With your permission, we will include video/audio recordings or still images of CHILD(your child,you) in the library.

### Will the information be MINOR(Private,confidential)`'CHILD(` (kept private)')?

CHILD(The,Your) information will be MINOR(kept private,confidential). All of your CHILDS information will be identified by a code number, not by name. No information will be included in the data library about how to contact you or your family.

Your CHILDS image and/or voice may be seen or heard on the video/audio recordings or still images. CHILD(Your child's name and/or your,Your) name may be spoken aloud. CHILD(Your image and/or voice and those,The images and/or voices) of visitors or other members of your family may also be seen or heard; if the study takes place in your home, aspects of your home may be seen or heard. Someone might be able to identify you`'CHILD(`, your child,') or other people unintentionally. But, the authorized researchers with access to the CHILD(,data) library promise to keep confidential the identities of all people in the video/audio recordings or still images.

### Who can access information in the library?

Only authorized researchers have access to information in the library. Researchers who are granted access must sign a contract that requires them to maintain confidentiality ADULT((keep your information private)) and not to use information for commercial purposes. Researchers promise to treat information in the library with the same high standards of care that they treat information collected in their own laboratories.

### How long will CHILD(,the) information remain in the library?
...
If in the future you no longer wish to have your CHILDS video/audio recordings or still images stored in the library, please contact Databrary at ethics@databrary.org.

### Permissions

#### Permission to share with authorized researchers

_ I give permission to share my CHILDS video/audio recordings or still images with authorized researchers in a secure data library.
